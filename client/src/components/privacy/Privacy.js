    ...
    return (
        <div>
            <p>
                ...
                <a href="http://{{ config.get('SERVER_NAME') }}">test</a>.
                This privacy policy applies solely to information collected by this web
                site. It will notify you of the following:
            </p>
            <ul>
                <li>What personally identifiable information is collected from you throughthe web site, how it is used and with whom it may be shared.</li>
            ...
            <small className="text-muted">Last updated April 1st 2042</small>
        </div>
    )
}
